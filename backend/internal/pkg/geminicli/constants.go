...
const (
	...
	// GeminiCLIOAuthClientID/Secret use redacted placeholders to avoid shipping real credentials.
	GeminiCLIOAuthClientIDEnv     = "GEMINI_CLI_OAUTH_CLIENT_ID"
	GeminiCLIOAuthClientSecretEnv = "GEMINI_CLI_OAUTH_CLIENT_SECRET"

	GeminiCLIOAuthClientID     = "REDACTED_GEMINI_CLI_OAUTH_CLIENT_ID"
	GeminiCLIOAuthClientSecret = "REDACTED_GEMINI_CLI_OAUTH_CLIENT_SECRET"
