...
// ClientID/defaultClientSecret 使用不可用的占位符，避免把真实凭据写入仓库。
var ClientID = "REDACTED_ANTIGRAVITY_OAUTH_CLIENT_ID"
var defaultClientSecret = "REDACTED_ANTIGRAVITY_OAUTH_CLIENT_SECRET"
...
func init() {
	...
	// 从环境变量读取 client_id / client_secret，未设置则保持占位符。
