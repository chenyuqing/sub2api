          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-paper-100 p-2 dark:bg-paper-900/30">
                <Icon name="server" size="md" class="text-paper-700 dark:text-paper-300" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-100 p-2 dark:bg-accent-900/30">
                <Icon name="chart" size="md" class="text-accent-700 dark:text-accent-300" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs">
                  ...
                  >
                  <span class="text-ink-400 dark:text-dark-500"> / </span>
                  <span
                  ...
                  <span class="text-ink-400 dark:text-dark-500"> / </span>
                  <span
                    class="text-ink-400 dark:text-dark-500"
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-ink-100 p-2 dark:bg-ink-900/30">
                <Icon name="database" size="md" class="text-ink-700 dark:text-ink-300" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
