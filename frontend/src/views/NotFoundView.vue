<template>
  <div
    class="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-paper-50 via-white to-ink-100/60 px-4 dark:from-dark-950 dark:via-dark-900 dark:to-dark-950"
  >
      ...
      <div class="mb-8">
        <div class="relative inline-block">
          ...
          <div class="absolute inset-0 flex items-center justify-center">
            <div
              class="flex h-24 w-24 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-600 to-amber-600 shadow-lg shadow-primary-500/20"
            >
              <svg
