  ...
  >
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 dark:border-dark-600 dark:bg-dark-700 dark:text-gray-200" data-tour="account-form-platform">
          <span class="font-medium text-gray-900 dark:text-white">OpenAI / GPT</span>
          <span class="ml-2 text-gray-500 dark:text-gray-400">{{ t('admin.accounts.platform') }}</span>
        </div>
      </div>
