            ...
            <template v-for="group in displayGroupStats" :key="group.group_id">
              ...
              >
                <td
                  ...
                  :class="group.group_id > 0 ? 'text-primary-600 hover:text-primary-700 dark:text-primary-300 dark:hover:text-primary-200' : 'text-gray-900 dark:text-white'"
                ...
                <td class="py-1.5 text-right text-accent-600 dark:text-accent-300">
